...
function themo_vertical_align_project_thumb(){
    ...
    jQuery( ".portfolio-item" ).each(function() {
       ...
       // jQuery("#"+parentID).height(containerHeight+'px');
		...
		/*bhavik change here */
		jQuery("#"+parentID).height('275px');
		jQuery("#"+parentID + " .port-inner").height('275px');
...
jQuery(document).on('click','.home-video-wrap',function(){
   jQuery(this).addClass('video-play');
   var v_url = jQuery(this).find('.wpb_video_wrapper iframe').attr('src');
   jQuery(this).find('.wpb_video_wrapper iframe').attr('src',v_url+'&autoplay=1');
});
