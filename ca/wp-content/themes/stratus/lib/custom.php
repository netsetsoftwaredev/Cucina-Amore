    ...
    foreach ( $pages as $page ) {
        //$page->ID;
            switch ($page->post_title) {
                case 'Home Product':
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('home-product'));
                    ...
                    update_post_meta($page->ID, 'themo_tour_1_groups', term_exists('home-product'));
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('home-product'));
                    update_post_meta($page->ID, 'themo_testimonials_1_groups', term_exists('home-product'));
                    break;
                case 'Home One Pager':
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('home-product'));
                    update_post_meta($page->ID, 'themo_showcase_2_groups', term_exists('home-product-2'));
                    update_post_meta($page->ID, 'themo_service_block_split_1_groups', term_exists('home-product'));
                    update_post_meta($page->ID, 'themo_tour_1_groups', term_exists('home-product'));
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('home-product'));
                    update_post_meta($page->ID, 'themo_testimonials_1_groups', term_exists('home-product'));
                    break;
                case 'Home Product 2':
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('home-product-2'));
                    update_post_meta($page->ID, 'themo_showcase_2_groups', term_exists('home-product-2'));
                    update_post_meta($page->ID, 'themo_service_block_split_1_groups', term_exists('home-product-2'));
                    update_post_meta($page->ID, 'themo_testimonials_1_groups', term_exists('home-product-2'));
                    update_post_meta($page->ID, 'themo_tour_1_groups', term_exists('home-product-2'));
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('home-product'));
                    break;
                case 'Home Sign Up':
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('home-3'));
                    break;
                case 'Home App':
                    ...
                    break;
                case 'Home App 2':
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('home-app-2'));
                    update_post_meta($page->ID, 'themo_brands_1_groups', term_exists('home-app-2'));
                    update_post_meta($page->ID, 'themo_tour_1_groups', term_exists('home-app-2'));
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('home-app-2'));
                    update_post_meta($page->ID, 'themo_service_block_2_groups', term_exists('home-app'));
                    update_post_meta($page->ID, 'themo_testimonials_1_groups', term_exists('home-app-2'));
                    break;
                case 'Home Shop':
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('home-shop'));
                    break;
                case 'Home Cloud':
                ...
                case 'Tour 2':
                    ...
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('tour-2-group-1'));
                    break;
                case 'Showcase':
                ...
                case 'Portfolio 5 Column':
                    ...
                    break;
                case 'About':
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('about'));
                ...
                case 'Careers':
                    ...
                    break;
                case 'Pricing':
                    update_post_meta($page->ID, 'themo_pricing_plans_1_groups', term_exists('3-col-pricing'));
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('home-3'));
                    break;
                case 'Pricing Plan Options':
                    ...
                    break;
                case 'Contact':
                    update_post_meta($page->ID, 'themo_service_block_split_1_groups', term_exists('home-2-service-bock-1'));
                    break;
                case 'Contact 2':
                    update_post_meta($page->ID, 'themo_service_block_split_1_groups', term_exists('home-2-service-bock-1'));
                    break;
                case 'Support / Help / FAQ':
                    update_post_meta($page->ID, 'themo_service_block_1_groups', term_exists('support'));
                    update_post_meta($page->ID, 'themo_faq_1_groups', term_exists('support'));
                    update_post_meta($page->ID, 'themo_slider_flex_groups', term_exists('support'));
                    break;
		}
	}
}
