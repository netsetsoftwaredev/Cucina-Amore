 ...
 * CLP Model
 */
class CLP extends AbstractModel
{
    ...
    {
        $this->_init('Rocktechnolabs\CLP\Model\ResourceModel\CLP');
    }
     ...
     * @return $string
     */
    public function getProducts(\Rocktechnolabs\CLP\Model\CLP $object)
    {
        $tbl = $this->getResource()->getTable(\Rocktechnolabs\CLP\Model\ResourceModel\CLP::TBL_ATT_PRODUCT);
