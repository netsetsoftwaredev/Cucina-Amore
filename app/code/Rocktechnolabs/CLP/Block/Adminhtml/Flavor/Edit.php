 ...
 */
namespace Rocktechnolabs\CLP\Block\Adminhtml\Flavor;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'flavor_id';
        $this->_blockGroup = 'Rocktechnolabs_CLP';
        $this->_controller = 'adminhtml_Flavor';
        parent::_construct();
        $this->buttonList->update('save', 'label', __('Save Flavor'));
        $this->buttonList->add(
            'saveandcontinue',
            [
    ...
    {
        $newsRegistry = $this->_coreRegistry->registry('flavor_data');
        if ($newsRegistry->getId()) {
            $newsTitle = $this->escapeHtml($newsRegistry->getTitle());
            return __("Edit Flavor '%1'", $newsTitle);
        } else {
            return __('Add Flavor');
        }
    }
