...
use Rocktechnolabs\CLP\Model\CLPFactory; 
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     *
     * @var \Rocktechnolabs\StoreLocator\Model\CLPFactory
     */
    protected $CLPFactory;
     ...
     * @param \Rocktechnolabs\StoreLocator\Model\CLPFactory
    ...
    {
        return $this->getUrl('clp/clp/productsgrid', ['_current' => true]);
    }
    ...
    {
        $allstoreId = $this->getRequest()->getParam('clp_id');
        $allstore   = $this->CLPFactory->create();
        if ($allstoreId) {
