 ...
 */
namespace Rocktechnolabs\CLP\Block\Adminhtml\CLP;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'clp_id';
        $this->_blockGroup = 'Rocktechnolabs_CLP';
        $this->_controller = 'adminhtml_CLP';
        parent::_construct();
        $this->buttonList->update('save', 'label', __('Save CLP'));
        $this->buttonList->add(
            'saveandcontinue',
            [
    ...
    {
        $newsRegistry = $this->_coreRegistry->registry('clp_data');
        if ($newsRegistry->getId()) {
            $newsTitle = $this->escapeHtml($newsRegistry->getTitle());
            return __("Edit CLP '%1'", $newsTitle);
        } else {
            return __('Add CLP');
        }
    }
