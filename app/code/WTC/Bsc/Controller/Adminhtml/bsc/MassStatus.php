...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('bsc');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('WTC\Bsc\Model\Bsc')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('bsc/*/index');
    }
